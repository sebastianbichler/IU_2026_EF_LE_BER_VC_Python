...
Benchmarking: Messung der Performance (Zeit/Speicher) vor und nach der Anwendung des Schwerpunkts (z.B. Python Loop vs. NumPy Vectorization).

Profiling: Nutzung von Tools wie cProfile oder memory_profiler, um Engpässe wissenschaftlich nachzuweisen.
